...
namespace Control_Estoque.Data.Migrations
{
    ...
    [Migration("20240407023528_Models")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Control_Estoque.Models.Produto", b =>
                {
                    ...
                    b.Property<DateOnly>("DataCadastroProd")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Control_Estoque.Models.Inventario", b =>
                {
                    b.HasOne("Microsoft.AspNetCore.Identity.ApplicationUser", "Cpf")
                        .WithMany()
                        .HasForeignKey("CpfId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Microsoft.AspNetCore.Identity.ApplicationUser", "CpfNavigation")
                        .WithMany()
